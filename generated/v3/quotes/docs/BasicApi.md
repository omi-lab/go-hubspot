...
------------- | ------------- | -------------
[**Archive**](BasicApi.md#Archive) | **Delete** /crm/v3/objects/quotes/{quoteId} | Archive
[**Create**](BasicApi.md#Create) | **Post** /crm/v3/objects/quotes | Create
[**GetByID**](BasicApi.md#GetByID) | **Get** /crm/v3/objects/quotes/{quoteId} | Read
[**GetPage**](BasicApi.md#GetPage) | **Get** /crm/v3/objects/quotes | List
[**Update**](BasicApi.md#Update) | **Patch** /crm/v3/objects/quotes/{quoteId} | Update



## Archive

> Archive(ctx, quoteId).Execute()
...
func main() {
    ...
    resp, r, err := apiClient.BasicApi.Archive(context.Background(), quoteId).Execute()
    if err != nil {
...
> SimplePublicObjectWithAssociations GetByID(ctx, quoteId).Properties(properties).PropertiesWithHistory(propertiesWithHistory).Associations(associations).Archived(archived).IdProperty(idProperty).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.BasicApi.GetByID(context.Background(), quoteId).Properties(properties).PropertiesWithHistory(propertiesWithHistory).Associations(associations).Archived(archived).IdProperty(idProperty).Execute()
    if err != nil {
...
> SimplePublicObject Update(ctx, quoteId).SimplePublicObjectInput(simplePublicObjectInput).IdProperty(idProperty).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.BasicApi.Update(context.Background(), quoteId).SimplePublicObjectInput(simplePublicObjectInput).IdProperty(idProperty).Execute()
    if err != nil {
