...
------------ | ------------- | ------------- | -------------
*AssociationsApi* | [**AssociationsArchive**](docs/AssociationsApi.md#associationsarchive) | **Delete** /crm/v4/objects/quotes/{quoteId}/associations/{toObjectType}/{toObjectId} | Remove an association between two quotes
*AssociationsApi* | [**AssociationsCreate**](docs/AssociationsApi.md#associationscreate) | **Put** /crm/v4/objects/quotes/{quoteId}/associations/{toObjectType}/{toObjectId} | Associate a quote with another object
*AssociationsApi* | [**AssociationsGetAll**](docs/AssociationsApi.md#associationsgetall) | **Get** /crm/v4/objects/quotes/{quoteId}/associations/{toObjectType} | List associations of a quote by type
