...
------------- | ------------- | -------------
[**AssociationsArchive**](AssociationsApi.md#AssociationsArchive) | **Delete** /crm/v4/objects/feedback_submissions/{feedbackSubmissionId}/associations/{toObjectType}/{toObjectId} | Remove an association between two feedback submissions
[**AssociationsCreate**](AssociationsApi.md#AssociationsCreate) | **Put** /crm/v4/objects/feedback_submissions/{feedbackSubmissionId}/associations/{toObjectType}/{toObjectId} | Associate a feedback submission with another object
[**AssociationsGetPage**](AssociationsApi.md#AssociationsGetPage) | **Get** /crm/v4/objects/feedback_submissions/{feedbackSubmissionId}/associations/{toObjectType} | List associations of a feedback submission by type
