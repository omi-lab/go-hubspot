...
------------ | ------------- | ------------- | -------------
*AssociationsApi* | [**AssociationsArchive**](docs/AssociationsApi.md#associationsarchive) | **Delete** /crm/v4/objects/products/{productId}/associations/{toObjectType}/{toObjectId} | Remove an association between two products
*AssociationsApi* | [**AssociationsCreate**](docs/AssociationsApi.md#associationscreate) | **Put** /crm/v4/objects/products/{productId}/associations/{toObjectType}/{toObjectId} | Associate a product with another object
*AssociationsApi* | [**AssociationsGetAll**](docs/AssociationsApi.md#associationsgetall) | **Get** /crm/v4/objects/products/{productId}/associations/{toObjectType} | List associations of a product by type
