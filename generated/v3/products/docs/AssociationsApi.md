...
------------- | ------------- | -------------
[**AssociationsArchive**](AssociationsApi.md#AssociationsArchive) | **Delete** /crm/v4/objects/products/{productId}/associations/{toObjectType}/{toObjectId} | Remove an association between two products
[**AssociationsCreate**](AssociationsApi.md#AssociationsCreate) | **Put** /crm/v4/objects/products/{productId}/associations/{toObjectType}/{toObjectId} | Associate a product with another object
[**AssociationsGetAll**](AssociationsApi.md#AssociationsGetAll) | **Get** /crm/v4/objects/products/{productId}/associations/{toObjectType} | List associations of a product by type
