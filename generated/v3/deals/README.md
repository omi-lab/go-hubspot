...
------------ | ------------- | ------------- | -------------
*AssociationsApi* | [**AssociationsArchive**](docs/AssociationsApi.md#associationsarchive) | **Delete** /crm/v4/objects/deals/{dealId}/associations/{toObjectType}/{toObjectId} | Remove an association between two deals
*AssociationsApi* | [**AssociationsCreate**](docs/AssociationsApi.md#associationscreate) | **Put** /crm/v4/objects/deals/{dealId}/associations/{toObjectType}/{toObjectId} | Associate a deal with another object
*AssociationsApi* | [**AssociationsGetAll**](docs/AssociationsApi.md#associationsgetall) | **Get** /crm/v4/objects/deals/{dealId}/associations/{toObjectType} | List associations of a deal by type
