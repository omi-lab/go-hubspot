...
------------- | ------------- | -------------
[**AssociationsArchive**](AssociationsApi.md#AssociationsArchive) | **Delete** /crm/v4/objects/contacts/{contactId}/associations/{toObjectType}/{toObjectId} | Remove an association between two contacts
[**AssociationsCreate**](AssociationsApi.md#AssociationsCreate) | **Put** /crm/v4/objects/contacts/{contactId}/associations/{toObjectType}/{toObjectId} | Associate a contact with another object
[**AssociationsGetAll**](AssociationsApi.md#AssociationsGetAll) | **Get** /crm/v4/objects/contacts/{contactId}/associations/{toObjectType} | List associations of a contact by type



## AssociationsArchive

> AssociationsArchive(ctx, contactId, toObjectType, toObjectId, associationType).Execute()
...
func main() {
    ...
    resp, r, err := apiClient.AssociationsApi.AssociationsArchive(context.Background(), contactId, toObjectType, toObjectId, associationType).Execute()
    if err != nil {
...
> SimplePublicObjectWithAssociations AssociationsCreate(ctx, contactId, toObjectType, toObjectId, associationType).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.AssociationsApi.AssociationsCreate(context.Background(), contactId, toObjectType, toObjectId, associationType).Execute()
    if err != nil {
...
> CollectionResponseAssociatedIdForwardPaging AssociationsGetAll(ctx, contactId, toObjectType).After(after).Limit(limit).Execute()
