...
------------ | ------------- | ------------- | -------------
*AssociationsApi* | [**AssociationsArchive**](docs/AssociationsApi.md#associationsarchive) | **Delete** /crm/v4/objects/companies/{companyId}/associations/{toObjectType}/{toObjectId} | Remove an association between two companies
*AssociationsApi* | [**AssociationsCreate**](docs/AssociationsApi.md#associationscreate) | **Put** /crm/v4/objects/companies/{companyId}/associations/{toObjectType}/{toObjectId} | Associate a company with another object
*AssociationsApi* | [**AssociationsGetAll**](docs/AssociationsApi.md#associationsgetall) | **Get** /crm/v4/objects/companies/{companyId}/associations/{toObjectType} | List associations of a company by type
